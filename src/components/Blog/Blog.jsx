...
const Blog = () => {
  ...
  let articles = [
    ...
    {
      src: "http://n77816ey.beget.tech/assets/blog/post-2.png",
      date: "10.03.2024",
      title: "Погружение в последние тенденции в веб-дизайне: Цветовые палитры, шрифты и анимация",
    },
    {
      src: "http://n77816ey.beget.tech/assets/blog/post-3.png",
      date: "01.03.2024",
      ...
      <div className="main">
        ...
        <div className="blog-page__news">
          <Link to="/blog/1" className="big-post">
            <img src="http://n77816ey.beget.tech/assets/blog/posts/big-post.png" alt="blog picture" />
            <p>01.05.2024</p>
